...
function Project() {
  ...
  return (
    <div className=" px-2 mb-2 bg-[#303030]" >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 m-4 p-4" >
        ...
        <div className=" p-2 rounded-lg shadow-md relative h-auto w-full max-w-sm mx-auto" >
          ...
          <div className="p-4">
            <h5 className="text-slate-400 text-lg font-semibold">Music Library || FullStack</h5>
            ...
            <a href="https://github.com/YessicaRomero/Api-con-Nestjs-React.git" className="bottom-4 left-4 right-4 text-center  text-pink-300 font-semibold p-1 m-2 bg-gradient-to-r from-gray-900 via-slate-600 to-gray-500  hover:text-white rounded-md ">Code<GitHub /> </a>
          </div>
        </div>
        ...
        <div className=" p-2 rounded-lg shadow-md relative overflow-hidden w-full max-w-sm mx-auto" >
          ...
          <div className="p-4">
            <h5 className="text-slate-400 text-lg font-semibold">Trivia || FullStack</h5>
            ...
            <a href="https://github.com/YessicaRomero/triviaFullSatck.git" className="bottom-4 left-4 right-4 text-center  text-pink-300 font-semibold p-1 m-2 bg-gradient-to-r from-gray-900 via-slate-600 to-gray-500  hover:text-white rounded-md ">Code<GitHub /> </a>
          </div>
        </div>
        ...
        <div className=" p-2 rounded-lg shadow-md relative overflow-hidden w-full max-w-sm mx-auto" >
          ...
          <div className="p-4">
            <h5 className="text-slate-400 text-lg font-semibold">LandingPage Peluqueria || Front End </h5>
            ...
            <a href="https://github.com/YessicaRomero/LandingPage" className="bottom-4 left-4 right-4 text-center  text-pink-300 font-semibold p-1 m-2 bg-gradient-to-r from-gray-900 via-slate-600 to-gray-500  hover:text-white rounded-md">Code <GitHub /></a>
          </div>
        </div>
        ...
        <div className=" p-2 rounded-lg shadow-md relative overflow-hidden w-full max-w-sm mx-auto" >
          ...
          <div className="p-4">
            <h5 className="text-slate-400 text-lg font-semibold">Movies || Front End</h5>
            <p className="text-slate-100 text-sm mt-2 max-w-sm m-2">
            ...
            <a href="https://github.com/YessicaRomero/apiReact" className="bottom-4 left-4 right-4 text-center  text-pink-300 font-semibold p-1 m-2 bg-gradient-to-r from-gray-900 via-slate-600 to-gray-500  hover:text-white rounded-md "> Code <GitHub /></a>
        ...
        <div className=" p-2 rounded-lg shadow-md relative overflow-hidden w-full max-w-sm mx-auto" >
          ...
          <div className="p-4">
            <h5 className="text-slate-400 text-lg font-semibold">Trivia || Back end </h5>
            ...
            <a href="https://github.com/YessicaRomero/triviaBack.git" className="bottom-4 left-4 right-4 text-center  text-pink-300 font-semibold p-1 m-2 bg-gradient-to-r from-gray-900 via-slate-600 to-gray-500  hover:text-white rounded-md "> Code<GitHub /> </a>
          </div>
        </div>
